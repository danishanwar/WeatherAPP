$(function(){
	...
	$.getJSON('http://ipinfo.io', function(d){
		...
		$.ajax({
				url: "https://api.openweathermap.org/data/2.5/onecall?lat=" + loc[0] + "&lon=" + loc[1] + "&units=metric&exclude=hourly,minutely&appid=dd24fc277707c16b3f8eb090b5f0efb5",
				type: "GET",
				dataType: "jsonp",
				success: function(data){
					console.log(data);
					var widget = shows(data,d);
					$("#show").html(widget);
					$("#city").val('');
				}
			});
...
$(document).ready(function(){
	$('#submitWeather').click(function(){
		...
		if(city != ''){
			$.ajax({
				url: "http://api.openweathermap.org/data/2.5/weather?q=" + city + "&units=metric&appid=dd24fc277707c16b3f8eb090b5f0efb5",
				type: "GET",
				dataType: "jsonp",
				success: function(data){
					console.log(data);
...
function show(data){
	...
	return "<h3 style='font-size:40px;' class='text-center'>Current Weather for <span style='color:green; font-weight:bold;'>"+ data.name + "</span></h3>" +
		   ...
		   "<h3 style='padding-left:40px;'><strong style='color:blue;'>Feels Like</strong>: "+ data.main.feels_like +"&deg;C</h3>"+
		   "<h3 style='padding-left:40px;'><strong style='color:blue;'>Sunrise</strong>: "+ sunRisedate +"</h3>" +
		   "<h3 style='padding-left:40px;'><strong style='color:blue;'>Sunset</strong>: "+ sunSetdate +"</h3>" ;
}

function shows(data,d){
	var sunRisetimestamp = data.current.sunrise*1000;
	var sunRisedate = new Date(sunRisetimestamp);
	console.log(sunRisedate[0]);
	var sunSettimestamp = data.current.sunset*1000;
	var sunSetdate = new Date(sunSettimestamp);
	console.log(sunSetdate);
	return "<h3 style='font-size:40px;' class='text-center'>Current Weather for <span style='color:green; font-weight:bold;'> "+ d.city + "</span></h3>" +
		   "<h3 style='padding-left:40px;'><strong style='color:blue;'>Weather</strong>: "+ data.current.weather[0].main +"</h3>" +
		   "<h3 style='padding-left:40px;'><strong style='color:blue;'>Description</strong>: <img src='http://openweathermap.org/img/w/"+data.current.weather[0].icon+".png'>"+ data.current.weather[0].description + "</h3>" +
		   "<h3 style='padding-left:40px;'><strong style='color:blue;'>Temperature</strong>: "+ data.current.temp +"&deg;C</h3>"+
		   "<h3 style='padding-left:40px;'><strong style='color:blue;'>Pressure</strong>: "+ data.current.pressure +" hPa</h3>" +
		   "<h3 style='padding-left:40px;'><strong style='color:blue;'>Humidity</strong>: "+ data.current.humidity +" %</h3>" +
		   "<h3 style='padding-left:40px;'><strong style='color:blue;'>Wind Speed</strong>: "+ data.current.wind_speed +" m/s</h3>" +
		   "<h3 style='padding-left:40px;'><strong style='color:blue;'>Wind Direction</strong>: "+ data.current.wind_deg +"&deg</h3>" +
		   "<h3 style='padding-left:40px;'><strong style='color:blue;'>Feels Like</strong>: "+ data.current.feels_like +"&deg;C</h3>"+
		   "<h3 style='padding-left:40px;'><strong style='color:blue;'>Sunrise</strong>: "+ sunRisedate +"</h3>" +
		   "<h3 style='padding-left:40px;'><strong style='color:blue;'>Sunset</strong>: "+ sunSetdate +"</h3>" ;
}
...
/*initiate the autocomplete function on the "city" element, and pass along the countries array as possible autocomplete values:*/
